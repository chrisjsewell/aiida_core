...
class Archive:
    ...
    def unpack(self):
        ...
        if os.path.isdir(self.filepath):
            ...
            extract_tar(self.filepath, self.folder)
        elif zipfile.is_zipfile(self.filepath):
            extract_zip(self.filepath, self.folder)
        else:
    ...
    def _read_json_file(self, filename):
        ...
        try:
            ...
            raise CorruptArchive(f'the archive does not contain the required file `{filename}`')


def extract_zip(infile, folder):
